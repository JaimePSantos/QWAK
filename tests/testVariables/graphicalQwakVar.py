...
graphicalQwakVarValuesFile = os.path.join(
...
graphicalStaticProbDistCycleNewInitState = eval(
    graphicalQwakVarValues[2])
graphicalDynamicProbDistCycleNewInitState = eval(
    graphicalQwakVarValues[3])
...
graphicalDynamicGetInvPartRatio = eval(graphicalQwakVarValues[13])
