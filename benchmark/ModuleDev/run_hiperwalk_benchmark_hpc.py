...
pVal = 0.8
seed = 10
sample_range = range(0,35)
# Step 1: Create profiling data
# create_profiling_data(n_values,sample_range=range(0,10),t=10)
create_profiling_data_hiperwalk_hpc(n_values,sample_range=sample_range,t=10, pVal=pVal, seed=seed)
git_branch_commit_push('1', f'Completed HiperWalk calculations')
